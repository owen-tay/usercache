...
function RecordView({ record, onBack, teamId }) {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      ...
      {editMode && (
        <button onClick={handleSave} className="btn btn-success mb-4 ml-2">
          Save
        </button>
      )}
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden p-4">
        ...
        <div className="text-gray-700 text-sm mb-4">
          ...
          {renderField("National Insurance Number", editedRecord.nino || 'N/A', 'nino')}
        </div>
        ...
        <div className="text-gray-700 text-sm">
          ...
          {renderField("Department", editedRecord.department || 'N/A', 'department')}
          {renderField("Start Date", editedRecord.startDate || 'N/A', 'startDate')}
          {renderField("Employee ID", editedRecord.employeeId || 'N/A', 'employeeId')}
        </div>
      </div>
    </div>
  );
